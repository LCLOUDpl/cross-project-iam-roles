/*
 * Configuration file with permissions for admin role.
 */

locals {
  permissions_admin = {
    networkAndContainerAdmin = {
      description = "Access and administer nework and container resources"
      permissions = [
    ...
    storageAdmin = {
      description = "Access and administer compute and object storage resource"
      permissions = [
